...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private LinearLayout calculator,orderSide;
    ...
    private TextView gestTV,loginTV,pointShow;
    ...
    private void init()
    {
        ...
        pointShow = findViewById(R.id.pointShowID);
        orderSide = findViewById(R.id.orderSideId);
...
*/
    ...
    private void userUnActiveMethod()
    {
        ...
        orderSide.setVisibility(View.INVISIBLE);
    ...
    private void userActiveMethod()
    {
        ...
        orderSide.setVisibility(View.VISIBLE);
        ...
        myDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try
                {
                    ...
                    pointShow.setText("Point : "+user.getPoint());
                }catch (Exception e)
                {
